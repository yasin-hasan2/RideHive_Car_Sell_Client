...
const WhyUsCard = ({ icon, title }) => {
  return (
    <div className="text-center p-8 space-y-4 bg-slate-100 hover:bg-orange-100 hover:text-black transition duration-200 ease-in-out rounded-md cursor-pointer">
      {icon}
